...
function getColor(card, customTypes) {
  ...
  return t?.color || BUILTIN_COLORS[card.typeId] || '#8a8a8a'
}
          ...
          {cards.map(card => {
            ...
            return (
              ...
              >
                ...
                <text textAnchor="middle" y={32} fontSize={9} fill={isHov ? 'var(--text-primary,#f0f0f0)' : 'var(--text-muted,#8a8a8a)'} fontFamily="var(--font-body)">
